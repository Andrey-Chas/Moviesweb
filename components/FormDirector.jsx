const FormDirector = ({ type, director, setDirector, setImage, submitting, handleSubmit }) => {
    return (
        <>
                ...
                <div className="grid sm:grid-cols-2 gap-10">
                    <div className="relative flex items-center">
                        ...
                        <input type="text" required placeholder="Enter first name"
                            className="px-4 py-3.5 bg-black text-gray-500 w-full text-sm border-2 border-gray-500 focus:border-blue-500 rounded outline-none" onChange={(e) => setDirector({ ...director, firstName: e.target.value })} />
                    ...
                    <div className="relative flex items-center">
                        ...
                        <input type="text" required placeholder="Enter last name"
                            className="px-4 py-3.5 bg-black text-gray-500 w-full text-sm border-2 border-gray-500 focus:border-blue-500 rounded outline-none" onChange={(e) => setDirector({ ...director, lastName: e.target.value })} />
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-[18px] h-[18px] absolute right-4"
                            viewBox="0 0 24 24">
                            <circle cx="10" cy="7" r="6" data-original="#000000"></circle>
                            <path
                    ...
                    <div className="relative flex items-center sm:col-span-2">
                        ...
                        <input type="date" required placeholder="Enter date of birth"
                            className="px-4 py-3.5 bg-black text-gray-500 w-full text-sm border-2 border-gray-500 focus:border-blue-500 rounded outline-none" onChange={(e) => setDirector({ ...director, dateOfBirth: e.target.value })} />
                    </div>
                    <div className="relative flex items-center sm:col-span-2">
                        <label
                        ...
                        <textarea type="text" required placeholder="Enter biography"
                            className="px-4 py-3.5 bg-black text-gray-500 w-full text-sm border-2 border-gray-500 focus:border-blue-500 rounded outline-none" onChange={(e) => setDirector({ ...director, biography: e.target.value })} />
                    </div>
                    <div className="relative flex items-center sm:col-span-2">
