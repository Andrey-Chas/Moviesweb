                    ...
                    <div className="space-y-5">
                        <div>
                            ...
                            <div className="relative flex items-center">
                                <input name="name" type="text" required className="bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded-md outline-blue-500" placeholder="Enter name" onChange={(e) => setName(e.target.value)} />
                        ...
                        <div>
                            ...
                            <div className="relative flex items-center">
                                <input name="age" type="number" required className="bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded-md outline-blue-500" placeholder="Enter age" onChange={(e) => setAge(e.target.value)} />
                            </div>
                        </div>
                        <div>
                            <label className="text-sm mb-2 block">Gender</label>
                            <div className="space-x-6 relative flex items-center">
                                <input type="radio" className="w-5 h-5" value="Male" checked={gender === "Male"} onChange={(e) => setGender(e.target.value)} />
                                <label className="text-sm text-black ml-4">Male</label>
                                <input type="radio" className="w-5 h-5" value="Female" checked={gender === "Female"} onChange={(e) => setGender(e.target.value)} />
                                <label className="text-sm text-black ml-4">Female</label>
                                <input type="radio" className="w-5 h-5" value="Other" checked={gender === "Other"} onChange={(e) => setGender(e.target.value)} />
                                <label className="text-sm text-black ml-4">Other</label>
                            </div>
                        </div>
                        <div>
                            <label className="text-sm mb-2 block">Country</label>
                            <div className="relative flex items-center">
                                <input name="country" type="text" required className="bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded-md outline-blue-500" placeholder="Enter country" onChange={(e) => setCountry(e.target.value)} />
                            </div>
                        </div>
                        <div>
